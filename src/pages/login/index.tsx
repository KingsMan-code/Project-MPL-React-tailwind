...
//           onEnded={() => videoRef.current && videoRef.current.play()}
//         >
...
//             <img src="milleniumTratado.png" alt="Logo" className="w-300 h-300 mx-auto mb-2" />
...
//             <p>Não tem uma conta? <a href="/inscrever" className="text-blue-500">Inscrever-se</a></p>
//           </div>
//         </div>
//       </div>
//     </div>
...
//roda o video apenas 1 vez quado executa a pagina
      ...
      <div className="w-full lg:w-2/5 bg-white p-4 flex items-center justify-center">
        <div className="max-w-lg mb-20">
          ...
          <div className="mt-4 text-center">
            <p>
              Não tem uma conta?{" "}
              <a href="/inscrever" className="text-blue-500">
                Inscrever-se
              </a>
            </p>
          </div>
